...
window.onload = event => {
    ...
    $.get("http://127.0.0.1:8081/stations", function(data) {
...
endStation.on('change', (event) => {
    ...
    $.get("http://127.0.0.1:8081/station?source="+value, (data) => {
...
setSchedule = () => {
    ...
    $.get('http://127.0.0.1:8081/trips?source='+departureStation+'&dest='+arrivalStation, (data) => {
